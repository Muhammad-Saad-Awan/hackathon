    ...
    <div className={`${poppins.className} bg-white py-8  sm:px-8 px-16    `}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 place-items-baseline">
        <div className="bg-white  rounded-lg overflow-hidden ">
          <Image src="/icons/grid1.png" alt="Trenton modular sofa 3" width={240} height={174} className="w-full h-auto" />
          <div className="p-4">
        ...
        <div className="bg-white  rounded-lg overflow-hidden">
          <Image src="/icons/grid2.png" alt="Granite dining table with dining chair" width={240} height={174} className="w-full h-auto" />
          <div className="p-4">
            <h3 className="text-lg font-bold">Granite dining table with dining chair</h3>
            <p className=" ">Rs. 25,000.00</p>
          </div>
        </div>
        <div className="bg-white  rounded-lg overflow-hidden">
          <Image src="/icons/grid4.png" alt="Outdoor bar table and stool" width={240} height={174} className="w-full h-auto" />
          <div className="p-4">
        ...
        <div className="bg-white  rounded-lg overflow-hidden">
          <Image src="/icons/grid3.png" alt="Plain console with teak mirror" width={240} height={174} className="w-full h-auto" />
          <div className="p-4">
            <h3 className="text-lg font-bold">Plain console with teak mirror</h3>
            <p className="">Rs. 25,000.00</p>
          </div>
        </div>
      </div>
